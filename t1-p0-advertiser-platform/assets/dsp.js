...
const App = {
  ...
  view_plans(){
    return `<div class="page-head"><div><h1>广告投放</h1><p>查看和管理 CPD 代投与 RTB 自助投放 · ${DB.campaigns.length} 个计划</p></div><div class="spacer"></div><button class="btn btn-primary" onclick="App.startRtbCreate()">${svg(I.plus)}新建 RTB 投放</button></div>
  ...
  renderUnifiedPlans(){
    ...
    const heads=['选择','广告计划','状态','投放情况','投放类型','预算','花费','剩余预算','曝光','点击','CTR','CPC','CPM','开始日期','结束日期','创意状态','广告位 / 库存','订单编号','代投运营','操作'];
